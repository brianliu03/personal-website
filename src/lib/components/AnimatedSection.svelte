...
<div class="flex items-center justify-center" id={id} use:inview={ options } on:inview_change={ handleChange }>
  <div class="flex flex-col w-2/3 min-h-screen items-center justify-center scale-75 md:scale-90 lg:scale-100">
    {#if visible}
