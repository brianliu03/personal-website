<script>
  ...
  export let about = "Hello! I am interested in utilizing technology for human good, addressing pressing humanitarian issues, and creating empowering software for all. The current housing crisis has captured my attention, and I am exploring statistical and computational models to chronicle historical events and find relationships that explain variation. I am also interested in the intersection of math, music, and creativity. This includes human computer interaction, stochastic processes, and machine learning.";
...
<div class="flex flex-col">
  <div class="flex items-center justify-center space-x-16 mx-5 md:mx-10 md:space-x-32">
    <div class="flex flex-col">
      {#if visible}
    ...
    {#if visible}
      <img src={imageSrc} class="w-48 md:w-52 lg:w-72 object-cover rounded-3xl" alt="Avatar" in:fly="{{ y: -250, duration: 1000, delay: 1250 }}"/>
    {/if}
  </div>

  <div class="flex flex-wrap align-middle justify-center flex-col sm:flex-row space-x-5 sm:space-x-10 my-32">
    {#if visible}
