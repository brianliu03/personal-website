...
<div class="flex flex-col items-center px-20 space-x-10 bg-secondary-300" id="about">
  <h1 class="h2 font-semibold">{title}</h1>
  <hr class="w-16 border-2 border-primary-500 my-2">
  <p class="h4">
  ...
  <p class="h4 mt-4">
    Explore my work <a href="/work" class="text-primary-500">here</a>.
  </p>
</div>
