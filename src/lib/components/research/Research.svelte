...
<AnimatedSection decoration="w-16 h-4 bg-gradient-to-r from-amber-400 to-red-400" title="Research" id="Research">
  <div class="mt-28 flex flex-col space-y-56">
    {#each researchInfo as p, i }
